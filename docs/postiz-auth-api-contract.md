...
`GET /public/v1/internal/integrations` — each integration includes:
...
Set `POSTIZ_PROACTIVE_AUTH_HEALTH=1` on juston-app after Postiz with this contract is deployed.
