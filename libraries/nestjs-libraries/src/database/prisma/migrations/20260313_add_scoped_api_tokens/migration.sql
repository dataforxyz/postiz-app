...
-- CreateTable
CREATE TABLE "ApiTokenScope" (
    "id" TEXT NOT NULL,
    "apiTokenId" TEXT NOT NULL,
    "integrationId" TEXT NOT NULL,

    CONSTRAINT "ApiTokenScope_pkey" PRIMARY KEY ("id")
);
...
-- CreateIndex
CREATE INDEX "ApiTokenScope_integrationId_idx" ON "ApiTokenScope"("integrationId");

-- CreateIndex
CREATE UNIQUE INDEX "ApiTokenScope_apiTokenId_integrationId_key" ON "ApiTokenScope"("apiTokenId", "integrationId");
...
-- AddForeignKey
ALTER TABLE "ApiTokenScope" ADD CONSTRAINT "ApiTokenScope_apiTokenId_fkey" FOREIGN KEY ("apiTokenId") REFERENCES "ApiToken"("id") ON DELETE CASCADE ON UPDATE CASCADE;

-- AddForeignKey
ALTER TABLE "ApiTokenScope" ADD CONSTRAINT "ApiTokenScope_integrationId_fkey" FOREIGN KEY ("integrationId") REFERENCES "Integration"("id") ON DELETE CASCADE ON UPDATE CASCADE;
